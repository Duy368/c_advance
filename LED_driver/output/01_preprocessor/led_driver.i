# 0 "./led_driver/led_driver.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "./led_driver/led_driver.c"
# 1 "./led_driver/led_driver.h" 1
...
# 6 "./led_driver/led_driver.h" 2


# 7 "./led_driver/led_driver.h"
...
# 3 "./led_driver/led_driver.c" 2


# 4 "./led_driver/led_driver.c"
static uint32_t *led_buffer = 
# 4 "./led_driver/led_driver.c" 3 4
                             ((void *)0)
# 4 "./led_driver/led_driver.c"
                                 ;
...
void led_shutdown()
{
    if (led_buffer)
    {
        free(led_buffer);
        led_buffer = 
# 24 "./led_driver/led_driver.c" 3 4
                    ((void *)0)
# 24 "./led_driver/led_driver.c"
                        ;
        led_count = 0;
    }
}
